...
Several standard-physics observations become natural in this interpretation. Electron scattering can reveal internal proton structure because the probe couples to e-span-compatible moving nodes inside the proton. Different apparent quark responses correspond to different orientations and resonance roles of the confined quons. At the same time, a quon cannot be extracted as an independent stable object, because its resonance is maintained only by the full tetrahedral enclosure.
