...
To complement a Protons 3 q-span channels, a construct with 3 quons would be needed optimally without any e-span coupling. This is where the neutron drops in. In the most simple case a Neutron would by a 3 quon triangle with some specific axial alignment of their a-span axis. Such a construct seems not to provide any self-stable resonances though for their quons. Without additional support it might disintegrate.

After the deuteron-like extension, RQM can distinguish neutron-like roles more generally. A neutron is not introduced as one fixed geometry, but as the way a proton-like e-span endpoint becomes non-exposed while q-span closure capacity remains available.

Depending on context, this non-exposure may be achieved by internal compensation, by pair-stacking in a deuteron-like compound, or by embedding into a larger q-span lattice. Thereofore the geometry, stability, decay tendency, scattering response, and effective contribution to nuclear binding need not be identical 

Thus, RQM distinguishes at least three neutron representations: isolated, deuteron-bound, and lattice-bound. They are not different particles in the standard sense, but different resonance realizations of the same role: a 3 quon rotational (triangular) enclosure complementing Proton like structures.

Would a 3-quon oscillatory triangle be an isolated stable constuct? Without any additional surroundings. This structurs would most likely align the q-span axis ...

% ....................

\subsubsection{Isolated Neutron}

An isolated neutron must provide its own e-span compensation. In RQM, it may be modeled as an octahedral or double-pyramidal extension of the proton-like tetrahedron, with an additional opposite e-span node compensating the externally available proton-side channel. Schematically, this may be written as

[
pqqq e ,
]

where the (p)-like and (e)-like endpoints should not be read as free proton and electron objects, but as opposite compensating e-span nodes within the isolated neutron enclosure.

The three (q)-nodes remain the main inertial drivers of the structure. The opposite e-span nodes may close their channel directly or enter a mutual precessional compensation. Because this compensation is not perfectly symmetric with respect to the q-span rotation, the isolated neutron remains only metastable.

In RQM terms, neutron decay occurs when this internal compensation can no longer remain closed. The proton-like side reaches a stable anchored state, while the opposite e-span component is expelled as an electron-like structure. Any remaining asymmetric resonance imbalance may leave as a neutrino-like residual.

% ....................

\subsubsection{Deuteron-bound Neutron}

A neutron in a deuteron is not modeled as an isolated neutron placed next to an isolated proton. Instead, RQM treats the deuteron as a shared two-body q-span enclosure. Geometrically, it may be imagined as two pyramidal structures meeting at, or sharing, one central p-span node.
...
The deuteron-bound neutron is therefore pair-compensated. Its non-exposed e-span role is stabilized by the shared proton-neutron geometry rather than by a fragile internal compensation. This explains why the deuteron can remain stable while the isolated neutron cannot.

% ....................

\subsubsection{Lattice-bound Neutron}

In larger nuclei, a neutron becomes even less like an isolated object. RQM interprets it as a local q-span configuration embedded in a larger resonance lattice. Instead of carrying its own complete compensation structure, it may remain as an e-span triangle of three quons within the surrounding nuclear geometry.

In this case, the neutron is lattice-compensated. Its e-span endpoint is not externally exposed because the surrounding q-span network absorbs and balances the relevant channel relations. The neutron-like role is therefore defined by the larger compound rather than by a self-contained neutron enclosure.
...
This suggests several qualitative expectations. Free neutron decay should reflect failure of internal e-span compensation. Deuteron structure should show signatures of shared proton-neutron geometry rather than two independent nucleons. In larger nuclei, neutron contributions should depend strongly on local clustering and q-span embedding. Scattering experiments should therefore reveal different effective neutron responses depending on whether the neutron is isolated, weakly pair-bound, or deeply embedded in a nuclear lattice.

The transition from a Proton and Neutron has some specific meaning and explanation in different models. Nuclear physics simply see the Deuteron state as a lower-energy state which can not simply be left back to a full Proton and full Neutron. For RQM starting from a Deuteron, at least 3 e-span to q-span channels e<(e) and 2 resonance nodes (n) are needed additionally to stabilize the 3q-Neutron triangle. Probably the construct is more like a n-qqq-n structure where the two n-nodes (instead of calling them <e> or <p>) form a further channe.

So a deuteron is not simply a P next to a N. It is substantially different construct on its own.
